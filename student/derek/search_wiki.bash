...
then
    ...
    java -Xmx512m -cp $CP -Dclue_path_regex="../crossword_corpus/(.+).txt" -Dwikip_index_dir=$WIKIP_INDEX_HOME edu.umich.si.si561.SearchDriver $@ | sed 's/data0\/corpora\/wikipedia_2013\/articles/proj\/cs4701corpus/g'
fi
